...
//   5. Месяцев 0 — «Загрузите отчёт…»; месяцев 1 — подсказка, что нужны расчёты
//      за 2 РАЗНЫХ месяца (а не просто «2 отчёта»: 8 расчётов одного месяца =
//      1 точка); месяцев 2+ — рисуем графики.
//
      ...
      <section className="ma">
        ...
        {loading ? (
          ...
          <div className="ma-note">
            Загрузите отчёт, чтобы увидеть аналитику.
          </div>
        ) : (
          <>
            ...
            {series.length < 2 ? (
              <div className="ma-note">
                {rows.length >= 2
                  ...
                  : "Загрузите отчёты минимум за 2 разных месяца для отображения динамики."}
              </div>
            ) : (
              <>
