...
// ============================================================================
// GET /api/cloud/report-history  — серверный прокси чтения помесячной истории
// («Аналитика по месяцам»). Браузер РФ без VPN ходит сюда (Timeweb), а не
// напрямую в Supabase (AWS).
//
